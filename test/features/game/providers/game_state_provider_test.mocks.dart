...
// in poker_dice/test/features/game/providers/game_state_provider_test.dart.
...
import 'package:poker_dice/features/game/data/game_state_repository.dart'
    as _i4;
import 'package:poker_dice/features/game/models/game_state.dart' as _i5;
...
/// A class which mocks [GameStateRepository].
///
/// See the documentation for Mockito's code generation for more information.
class MockGameStateRepository extends _i1.Mock
    implements _i4.GameStateRepository {
  MockGameStateRepository() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<bool> saveGameState(_i5.GameState? state) =>
      (super.noSuchMethod(
            Invocation.method(#saveGameState, [state]),
            returnValue: _i3.Future<bool>.value(false),
          )
          as _i3.Future<bool>);

  @override
  _i3.Future<_i5.GameState?> loadGameState() =>
      (super.noSuchMethod(
            Invocation.method(#loadGameState, []),
            returnValue: _i3.Future<_i5.GameState?>.value(),
          )
          as _i3.Future<_i5.GameState?>);

  @override
  _i3.Future<bool> clearGameState() =>
      (super.noSuchMethod(
            Invocation.method(#clearGameState, []),
            returnValue: _i3.Future<bool>.value(false),
          )
          as _i3.Future<bool>);
}
